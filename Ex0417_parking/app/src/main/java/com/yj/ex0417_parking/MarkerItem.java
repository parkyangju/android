...
public class MarkerItem implements ClusterItem, Serializable {
    ...
    String msp_lat; //위도
    String msp_lon; //경도
//    String msp_price; //자리개수
    String msp_num; //자리개수
    String msp_type; //주차타입
    String msp_date; //작성일

    public MarkerItem(String msp_no, String msm_no, String msp_location, String msp_lat, String msp_lon, String msp_price, String msp_num, String msp_type, String msp_date) {
        this.msp_no = msp_no;
        this.msm_no = msm_no;
...
//        this.msp_price = msp_price;
    ...
    public MarkerItem(String msp_no, String msm_no, String msp_location, String msp_lat, String msp_lon, String msp_num, String msp_type, String msp_date) {
        this.msp_no = msp_no;
        this.msm_no = msm_no;
        this.msp_location = msp_location;
        this.msp_lat = msp_lat;
    ...
    public MarkerItem(MarkerItem markerItem) {
    }
